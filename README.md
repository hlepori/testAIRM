...
AeroplaneConfiguration : + lifecycleStageStatus [0..1] CharacterString	
...
Aircraft : + lifecycleStageStatus [0..1] CharacterString	
...
AircraftAddress : + lifecycleStageStatus [0..1] CharacterString	
...
AircraftAvionics : + lifecycleStageStatus [0..1] CharacterString	
...
AircraftCapability : + lifecycleStageStatus [0..1] CharacterString	
...
AircraftConfiguration : + lifecycleStageStatus [0..1] CharacterString	
...
AircraftEquipment : + lifecycleStageStatus [0..1] CharacterString	
...
AuxiliaryPowerUnit : + lifecycleStageStatus [0..1] CharacterString	
...
Engine : + lifecycleStageStatus [0..1] CharacterString	
...
FlightConfiguration : + lifecycleStageStatus [0..1] CharacterString	
...
OperatorConfiguration : + lifecycleStageStatus [0..1] CharacterString	
...
SurfaceVehicle : + lifecycleStageStatus [0..1] CharacterString	
...
TakeOffConfiguration : + lifecycleStageStatus [0..1] CharacterString	
...
Vehicle : + lifecycleStageStatus [0..1] CharacterString	
...
link CodeACASCapabilityType "https://airm.aero/developers/advanced-search/1.0.0/CodeACASCapabilityType?model=LogicalModel" "Go to definition"	
...
link CodeAircraftApproachCategoryType "https://airm.aero/developers/advanced-search/1.0.0/CodeAircraftApproachCategoryType?model=LogicalModel" "Go to definition"	
...
link CodeAircraftAvionicsEquipmentType "https://airm.aero/developers/advanced-search/1.0.0/CodeAircraftAvionicsEquipmentType?model=LogicalModel" "Go to definition"	
...
link CodeAircraftClassificationType "https://airm.aero/developers/advanced-search/1.0.0/CodeAircraftClassificationType?model=LogicalModel" "Go to definition"	
...
link CodeAircraftEngineNumberType "https://airm.aero/developers/advanced-search/1.0.0/CodeAircraftEngineNumberType?model=LogicalModel" "Go to definition"	
...
link CodeAircraftEngineType "https://airm.aero/developers/advanced-search/1.0.0/CodeAircraftEngineType?model=LogicalModel" "Go to definition"	
...
link CodeAircraftEquipmentType "https://airm.aero/developers/advanced-search/1.0.0/CodeAircraftEquipmentType?model=LogicalModel" "Go to definition"	
...
link CodeAircraftSurvivalEquipmentType "https://airm.aero/developers/advanced-search/1.0.0/CodeAircraftSurvivalEquipmentType?model=LogicalModel" "Go to definition"	
...
link CodeAircraftType "https://airm.aero/developers/advanced-search/1.0.0/CodeAircraftType?model=LogicalModel" "Go to definition"	
...
link CodeAircraftWingspanClassType "https://airm.aero/developers/advanced-search/1.0.0/CodeAircraftWingspanClassType?model=LogicalModel" "Go to definition"	
...
link CodeAltitudeReportingCapabilityType "https://airm.aero/developers/advanced-search/1.0.0/CodeAltitudeReportingCapabilityType?model=LogicalModel" "Go to definition"	
...
link CodeClassB2TransmitPowerCapabilityType "https://airm.aero/developers/advanced-search/1.0.0/CodeClassB2TransmitPowerCapabilityType?model=LogicalModel" "Go to definition"	
...
link CodeDatalinkCommunicationCapabilityType "https://airm.aero/developers/advanced-search/1.0.0/CodeDatalinkCommunicationCapabilityType?model=LogicalModel" "Go to definition"	
...
link CodeEquipmentStatusType "https://airm.aero/developers/advanced-search/1.0.0/CodeEquipmentStatusType?model=LogicalModel" "Go to definition"	
...
link CodeHelicopterPerformanceType "https://airm.aero/developers/advanced-search/1.0.0/CodeHelicopterPerformanceType?model=LogicalModel" "Go to definition"	
...
link CodeLifeJacketEquipmentType "https://airm.aero/developers/advanced-search/1.0.0/CodeLifeJacketEquipmentType?model=LogicalModel" "Go to definition"	
...
link CodeNoiseCertificationType "https://airm.aero/developers/advanced-search/1.0.0/CodeNoiseCertificationType?model=LogicalModel" "Go to definition"	
...
link CodeSurfaceVehicleIdentificationType "https://airm.aero/developers/advanced-search/1.0.0/CodeSurfaceVehicleIdentificationType?model=LogicalModel" "Go to definition"	
...
link CodeSurveillanceCapabilityType "https://airm.aero/developers/advanced-search/1.0.0/CodeSurveillanceCapabilityType?model=LogicalModel" "Go to definition"	
...
link CodeSurvivalEquipmentType "https://airm.aero/developers/advanced-search/1.0.0/CodeSurvivalEquipmentType?model=LogicalModel" "Go to definition"	
...
link CodeTargetTrajectoryChangeReportCapabilityType "https://airm.aero/developers/advanced-search/1.0.0/CodeTargetTrajectoryChangeReportCapabilityType?model=LogicalModel" "Go to definition"	
...
link CodeTerrainAwarenessAndGroundProximityAlertingCapability "https://airm.aero/developers/advanced-search/1.0.0/CodeTerrainAwarenessAndGroundProximityAlertingCapability?model=LogicalModel" "Go to definition"	
...
link CodeTransponderType "https://airm.aero/developers/advanced-search/1.0.0/CodeTransponderType?model=LogicalModel" "Go to definition"	
...
link CodeWakeTurbulenceCategoryType "https://airm.aero/developers/advanced-search/1.0.0/CodeWakeTurbulenceCategoryType?model=LogicalModel" "Go to definition"	
...
link CodeWakeVortexClassificationType "https://airm.aero/developers/advanced-search/1.0.0/CodeWakeVortexClassificationType?model=LogicalModel" "Go to definition"	
